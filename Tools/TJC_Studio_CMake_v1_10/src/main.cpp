...
static void generateIno(const std::string& dir, const std::string& className, const std::vector<Page>& pages)
{
    ...
    ino << "    Serial.println(\"===== TJC v1.10 generated Arduino project =====\");\n";
    ino << "}\n\n";
...
static void generateReadme(const std::string& dir, const std::string& className)
{
    ...
    out << "Generated by TJC_Studio v1.10.0.\n\n";
    out << "## Files\n\n";
    out << "- `" << className << ".ino`\n";
    out << "- `" << className << ".h`\n";
    out << "- `" << className << ".cpp`\n";
    ...
    out << "Requires `TJC_Display` v1.10.0 or newer.\n";
}
...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        h << "// Generated by TJC_Studio v1.10.0\n";
        ...
        cpp << "// Generated by TJC_Studio v1.10.0\n";
        ...
        json << "{\n";
        json << "  \"generator\": \"TJC_Studio v1.10.0\",\n";
        json << "  \"pages\": [\n";
