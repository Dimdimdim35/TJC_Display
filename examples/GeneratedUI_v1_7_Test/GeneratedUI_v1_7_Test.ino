...
{
public:
    void onStartRelease() override { Serial.println("Controller START"); }
    void onSliderRelease() override { Serial.println("Controller SLIDER"); }
    void onBt0Release() override { Serial.println("Controller DUAL"); }
};
...
void setup()
{
    ...
    Serial.println("===== TJC v1.7 callbacks/pages/controller =====");
}
